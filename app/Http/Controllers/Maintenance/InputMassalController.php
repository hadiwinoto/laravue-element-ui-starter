    ...
    public function importData(Request $request){
        ...
        for ($i = 0; $i < $jml; $i++) {
            ...
            $arr = [
                ...
                'tanggal_perbaikan'     => $spreadsheet->getActiveSheet()->getCell('A' . $start)->getOldCalculatedValue(),
                ...
                'tanggal_selesai'       => $spreadsheet->getActiveSheet()->getCell('J' . $start)->getOldCalculatedValue(),
